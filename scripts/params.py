...
CYCLE = 256 #number of images generated to one particle (should be greater than 1 only when coordinate shuffling is enabled)
...
if SHUFFLE not in ['partial','full']:
    ...
    LOG_FILE = f'{DB}{TYPE_OF_IMAGE}{MODEL}_{MARGIN}_e{EPOCHS}_{PREDICTED_VALUE}_bs{BATCH_SIZE}_shuffle_{SHUFFLE}_{CYCLE}.log' 
